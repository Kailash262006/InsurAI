...
public class RiskRequest {
    ...
    public boolean isExistingInsurance() { return existingInsurance; }
    public void setExistingInsurance(boolean existingInsurance) { this.existingInsurance = existingInsurance; }
}